...
#ifndef GTS_DSMCC_BIOP_PARSERS_OBJECT_INFO_HPP
#define GTS_DSMCC_BIOP_PARSERS_OBJECT_INFO_HPP
...
boost::iterator_range<BaseIterator> object_info(BaseIterator& first, BaseIterator last)
{
  typedef boost::mpl::int_<16> size_bits_size;
